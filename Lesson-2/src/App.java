...
public class App {
    public static void main(String[] args){
        // List<Student> userList1 = Arrays.asList(new Student("Yasha", 20, 5555, 1)
        //                                         , new Student("Anton", 18, 333,1)
        //                                         , new Student("Viktor", 26, 4444, 1));
        ...
        // List<Student> userList2 = Arrays.asList(new Student("Misha", 24, 5555, 2)
        //                                         , new Student("Nikolai", 19, 333,2)); 
        // StudentGroup studentGroup2 = new StudentGroup(userList2, 2);

        // List<Student> userList3 = Arrays.asList(new Student("Alex", 24, 5555, 3));
